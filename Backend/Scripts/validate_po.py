...
HEADER_RULES = {
    "PO Number":     {"type": "character", "max_len": 8},
    ...
    "Ship To Site":  {"type": "character", "max_len": 8},
    "Bill To Code":  {"type": "character", "max_len": 8},
    "Order Date":    {"type": "date"},
    "Due Date":      {"type": "date"},
    "Exchange Rate": {"type": "decimal",   "min": 0, "optional": True},
    "Ship Via":      {"type": "character", "max_len": 20, "optional": True},
}
...
def run_standalone():
    ...
    folder = os.path.abspath(os.path.join(ROOT_DIR, CONFIG["folders"]["purchase_order"]))
