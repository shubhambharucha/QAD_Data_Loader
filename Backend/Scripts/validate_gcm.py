...
FIELD_RULES = {
    ...
    "Field Name": {"type": "character", "max_len": 16},
    "Value":      {"type": "character", "max_len": 20},
    "Comment":    {"type": "character", "max_len": 60},
    "Group":      {"type": "character", "max_len": 10},
}
...
def run_standalone():
    ...
    folder = os.path.abspath(os.path.join(ROOT_DIR, CONFIG["folders"]["GCM"]))
